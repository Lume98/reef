...
use crate::{
    ...
    native_panel_scene::{resolve_panel_shell_scene_state, PanelRuntimeRenderState, PanelScene},
};
...
pub fn native_panel_status_close_preservation_active(
    transitioning: bool,
    expanded: bool,
...
pub fn native_panel_status_close_scene_has_cards(scene: &PanelScene) -> bool {
    scene.surface == ExpandedSurface::Status && !scene.cards.is_empty()
}

pub fn resolve_native_panel_preserved_status_close_scene(
...
pub fn resolve_native_panel_preserved_status_close_scene_for_snapshot(
    cache: &NativePanelRuntimeSceneCache,
...
pub fn native_panel_runtime_render_state_from_preserved_scene(
    transitioning: bool,
    scene: &PanelScene,
...
mod tests {
    ...
    use crate::native_panel_ui::runtime_scene_cache::NativePanelRuntimeSceneCache;
