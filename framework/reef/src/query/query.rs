use crate::query::cache::{cache_query, get_cached, invalidate_query};
...
pub fn use_query<T: Clone + 'static>(key: &'static str, fetcher: impl Fn() -> T) -> QueryResult<T> {
...
pub fn refresh_query<T: Clone + 'static>(key: &'static str, fetcher: impl Fn() -> T) -> T {
...
mod tests {
    use super::*;
    use crate::query::cache::{cache_query, get_cached};
