...
use crate::draw::primitive::{DrawPlan, DrawPrimitive};
use crate::view::widget_host::{PaintContext, Widget};

use crate::widgets::island::ExpandedCardStack;
...
pub(crate) fn render_island_widget_primitives(
    ...
    let mut ctx = crate::view::widget_host::PaintContext { primitives };
    ...
    if widget.mode == DisplayMode::Expanded {
        ...
        if sep_vis > 0.0 {
            ...
            shell.separator_color =
                crate::core::color::Color::rgba(40, 44, 54, (0.5 * sep_vis * 255.0) as u8);
        }
