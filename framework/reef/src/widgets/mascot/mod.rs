...
pub use parts::{
    MascotBody, MascotDot, MascotExpression, MascotEye, MascotEyes, MascotShadow, MascotSprite,
};
...
pub struct MascotWidget {
    ...
    pub eye_color: crate::core::color::Color,
    pub alpha: f64,
...
impl MascotWidget {
    pub fn new(center_x: f64, center_y: f64, radius: f64) -> Self {
        Self {
            ...
            elapsed_ms: 0,
            fill_color: crate::core::color::Color::from(theme::FILL),
            stroke_color: crate::core::color::Color::from(theme::STROKE),
            eye_color: crate::core::color::Color::from(theme::EYE),
            alpha: 1.0,
            offset_x: 0.0,
            offset_y: 0.0,
            scale_x: 1.0,
