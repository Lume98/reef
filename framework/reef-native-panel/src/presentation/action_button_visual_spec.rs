...
use crate::state::{resolve_compact_action_button_layout, PanelRect};
...
mod tests {
    use crate::{
        ...
        state::{resolve_compact_action_button_layout, PanelRect},
    };
    ...
    fn action_button_transition_progress_follows_compact_width() {
        ...
        let mid = action_button_transition_progress_from_compact_width(
            (crate::state::DEFAULT_COMPACT_PILL_WIDTH + crate::state::DEFAULT_EXPANDED_PILL_WIDTH)
                / 2.0,
        );
