...
pub struct NativePanelRuntimeInputDescriptor {
    pub scene_input: crate::scene::PanelSceneBuildInput,
...
pub fn native_panel_runtime_input_descriptor_with_screen_frame(
    ...
    NativePanelRuntimeInputDescriptor {
        scene_input: crate::scene::PanelSceneBuildInput::default(),
        screen_frame,
    }
}
...
pub struct NativePanelRuntimeInputContext {
    pub display_options: Vec<crate::scene::PanelDisplayOptionState>,
