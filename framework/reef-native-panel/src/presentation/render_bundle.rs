use crate::{
    ...
    state::{ExpandedSurface, PanelLayout, PanelRect, PanelRenderState},
};
...
) -> reef::draw::draw_backend::FrameSubmission {
...
pub fn native_panel_card_stack_command(
    ...
    NativePanelCardStackCommand {
        ...
        content_height,
        body_height: content_height.min(crate::state::EXPANDED_MAX_BODY_HEIGHT),
        visible,
    }
}
