...
use crate::{
    scene::{PanelRuntimeRenderState, PanelScene, SceneCard, SceneText},
    state::{PanelLayout, PanelRect, PanelRenderState, EXPANDED_MAX_BODY_HEIGHT},
};
...
pub struct NativePanelShellPresentationInput {
    pub surface: crate::state::ExpandedSurface,
    pub visible: bool,
...
pub struct NativePanelMascotPresentationInput {
    pub pose: crate::scene::SceneMascotPose,
...
pub struct NativePanelGlowPresentationInput {
    pub glow: crate::scene::SceneGlow,
}
...
impl NativePanelSnapshotRenderPlan {
    ...
    pub fn surface(&self) -> crate::state::ExpandedSurface {
...
pub fn native_panel_visual_plan_input_from_presentation(
    ...
    NativePanelPaintInput {
        ...
        surface: presentation
            ...
            .unwrap_or(crate::state::ExpandedSurface::Default),
        ...
        mascot_pose: presentation
            ...
            .unwrap_or(crate::scene::SceneMascotPose::Idle),
...
mod tests {
    ...
    fn fallback_presentation_model_uses_scene_content() {
        let scene = build_panel_scene(
            &crate::state::PanelState::default(),
            &snapshot("idle"),
    ...
    fn resolved_presentation_keeps_render_bundle_and_presentation_in_sync() {
        ...
        let render_state = resolve_panel_render_state(crate::state::PanelRenderStateInput {
