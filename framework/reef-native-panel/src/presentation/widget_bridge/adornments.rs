...
use crate::state::{PanelChromeVisibilitySpec, PanelPoint, PanelRect};
use reef::core::color::Color;
use reef::core::geometry::Rect;
use reef::theme::compact_bar as compact_theme;
use reef::widgets::compact_bar::{CompactShoulder, CompletionGlow, ShoulderSide};
use reef::widgets::mascot::{CompletionBadge, MascotPose, MascotWidget};
