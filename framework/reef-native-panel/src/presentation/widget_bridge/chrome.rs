use crate::presentation::visual_plan::{
    resolve_compact_chrome_visibility, NativePanelPaintInput, NativePanelVisualDisplayMode,
};
use crate::state::{PanelChromeVisibilitySpec, EXPANDED_PANEL_RADIUS};
use reef::core::color::Color;
use reef::theme::panel as panel_theme;
use reef::widgets::compact_bar::{ChromeVisibility, CompactBar, CompactShoulder, CompletionGlow};
use reef::widgets::island::ExpandedShell;
use reef::widgets::island_widget::{DisplayMode, IslandWidgetLayout};
use reef::widgets::mascot::MascotWidget;
