...
use super::{
    host_runtime::WindowsPanelHost, paint_bridge::present_window_into_presenter,
    WindowsPanelRenderer,
};

impl NativePanelHost for WindowsPanelHost {
    type Error = String;
    type Renderer = WindowsPanelRenderer;
...
impl NativePanelSceneHost for WindowsPanelHost {}

impl NativePanelPointerRegionInteractionBridge for WindowsPanelHost {
...
impl NativePanelQueuedPlatformEventBridge for WindowsPanelHost {
...
impl NativePanelRuntimeHostController for WindowsPanelHost {
    type Error = String;
