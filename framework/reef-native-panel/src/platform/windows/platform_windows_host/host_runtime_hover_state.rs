...
use super::{
    host_runtime::WindowsPanelRuntime, platform_loop::current_windows_panel_pointer_polling_sample,
};
use crate::{
    runtime::facade::{
    ...
    state::{HoverTransition, PanelPoint},
};
...
impl WindowsPanelRuntime {
    ...
    pub(super) fn sync_host_polling_interaction_and_refresh_impl(
        ...
        primary_mouse_down: bool,
        now: Instant,
        input: &crate::runtime::facade::descriptor::NativePanelRuntimeInputDescriptor,
    ...
    pub(super) fn sync_current_pointer_polling_interaction_impl(
        ...
        let Some(sample) =
            current_windows_panel_pointer_polling_sample(self.host.shell.raw_window_handle())
        else {
