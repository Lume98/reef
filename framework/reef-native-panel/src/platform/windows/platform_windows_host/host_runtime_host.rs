...
use super::{
    host_runtime::WindowsPanelHost,
    host_window::WindowsPanelDrawFrame,
    paint_bridge::{
        consume_presenter_into_shell, consume_presenter_into_shell_result, take_pending_draw_frame,
    },
    window_shell::{WindowsPanelShellCommand, WindowsPanelShellPresentResult},
};
...
impl WindowsPanelHost {
    ...
    pub(super) fn take_pending_shell_commands(&mut self) -> Vec<WindowsPanelShellCommand> {
    ...
    pub(super) fn consume_presenter_into_shell_result(&mut self) -> WindowsPanelShellPresentResult {
