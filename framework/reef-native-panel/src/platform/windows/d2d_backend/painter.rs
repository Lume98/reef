...
impl DrawBackend for Direct2DPainter {
    ...
    fn submit_frame(
        &mut self,
        submission: &reef::draw::draw_backend::FrameSubmission,
    ) -> Result<(), Self::Error> {
...
pub fn resolve_paint_operations(plan: &reef::draw::primitive::DrawPlan) -> Vec<PaintOperation> {
    if plan.hidden {
        return Vec::new();
    }
    plan.primitives
...
pub enum PaintOperation {
    ...
    StrokeLine {
        from: reef::core::geometry::Point,
        to: reef::core::geometry::Point,
        color: reef::core::color::Color,
        width: f64,
        alpha: f64,
    },
    ...
    FillStrokedRoundRect {
        frame: Rect,
        radius: f64,
        fill: reef::core::color::Color,
        stroke: reef::core::color::Color,
        stroke_width: f64,
        alpha: f64,
    },
    DrawNineSliceImage {
    ...
    FillPath {
        segments: Vec<reef::draw::primitive::PathSegment>,
        fill: reef::core::color::Color,
        alpha: f64,
    },
    DrawSpriteImage {
...
mod tests {
    ...
    fn resolve_paint_operations_maps_all_variants() {
        let mut plan = reef::draw::primitive::DrawPlan::with_viewport(Size {
            width: 100.0,
            height: 100.0,
        });
        plan.primitives = vec![
