use crate::presentation::descriptor::NativePanelPointerRegion;
use crate::state::{resolve_native_panel_host_frame, PanelAnimationDescriptor, PanelRect};
...
pub fn resolve_windows_panel_window_frame(
    ...
    let host_compact_width = compact_width.max(crate::state::DEFAULT_PANEL_CANVAS_WIDTH);
    let host_expanded_width = expanded_width.max(crate::state::DEFAULT_PANEL_CANVAS_WIDTH);
