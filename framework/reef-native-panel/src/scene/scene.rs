...
use crate::scene::{SessionSurfaceScene, SettingsSurfaceScene, StatusCardScene, SurfaceScene};
use crate::state::{
...
pub fn resolve_scene_cards_total_height(
    ...
    let card_heights = scene
        ...
        .collect::<Vec<_>>();
    crate::state::resolve_stacked_cards_total_height(&card_heights, card_gap, empty_height)
}
