...
use super::runtime_settings_surface::{
    mutate_panel_state_state, resolve_native_panel_settings_surface_snapshot_update_for_state,
...
mod tests {
    ...
    fn visual_input(display_mode: NativePanelVisualDisplayMode) -> NativePanelPaintInput {
    ...
    impl crate::runtime::traits::NativePanelRuntime for TestInteractionHost {
        type Error = String;
    ...
    fn shared_hover_rerender_without_snapshot_does_not_clear_badge_or_expand() {
        ...
        let mut state = PanelState {
            expanded: false,
            pointer_inside_since: Some(now - Duration::from_millis(700)),
            completion_badge_items: vec![crate::state::CompletionBadgeItem {
    ...
    fn shared_host_polling_interaction_updates_mouse_passthrough_state() {
        ...
        assert_eq!(
            ...
            vec![
                crate::runtime::runtime_interaction::NativePanelHostBehaviorCommand::SetMouseEventPassthrough {
