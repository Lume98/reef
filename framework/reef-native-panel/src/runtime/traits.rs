...
pub(crate) trait NativePanelHost {
    type Error;
    type Renderer: NativePanelRuntime<Error = Self::Error>;
...
mod tests {
    use super::{
        ...
        NativePanelPlatformEvent, NativePanelRuntime, NativePanelRuntimeCommand,
    ...
    fn test_scene() -> PanelScene {
        PanelScene {
            ...
            surface_scene: SurfaceScene {
                mode: crate::scene::surface_scene_mode(crate::state::ExpandedSurface::Default),
            ...
            settings_surface: crate::scene::build_settings_surface_scene(
                crate::scene::resolve_settings_surface_projection(
                    &[crate::scene::fallback_panel_display_option()],
                    crate::state::PanelSettingsState::default(),
                ),
                crate::state::PanelSettingsState::default(),
                "0.0.0",
